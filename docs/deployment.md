...
`f4a619b`, including the Harness, Knowledge, People, Memory, Task, Routine,
Connected Accounts, Channels, Billing, and the built Vercel API entrypoint. A fresh unauthenticated check still
shows:
...
- Deployment: `dpl_GB8a5hCDBhqFUcB9ABpEq3KfUdpV`
- Protected direct URL: `https://town-clear-current-qvpcl8h7j-123oqwes-projects.vercel.app`
- State: `READY`
