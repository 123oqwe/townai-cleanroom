...
| Routines and triggers                  | Implemented                          | `packages/routines`, immutable version history, expiring/revocable Routine share grants, scheduler/trigger tests, Routine UI             | A schedule only reports server-returned queued state                                                            |
